...
class Output(TypedDict, total=False):
    ...
    Describes the output produced by the move-granules task
    """

    granuleDuplicates: Dict[str, "_OutputGranuleduplicatesAdditionalproperties"]
    granules: List["_OutputGranulesItem"]
    """Array of all granules."""


_OutputGranuleduplicatesAdditionalproperties = Any
